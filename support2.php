	...
	<?php
		...
		if(isset($_POST['send'])){
			...
			$error="Please enter some text";}
				...
				$error=" ";
				$statement="We will take your feedback into consideration...";
			}
			}
		echo "<p style='font-size: 16px; letter-spacing: 0.25px; color:navy';>".$statement."</p>";
		echo "<p style='font-size: 16px; letter-spacing: 0.25px; color:red';>".$error."</p>";
	?>
	<br><br>
	
	<center>
	<button type="submit" class="transparent-button2" name="send"><b>Send</b></button>
	<br><br><br><br>
	<a href="support1.php" button class="transparent-button">Back</a></button>
